...
double cTerrainGen2D::BuildFlat(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
	return AddFlat(width, out_data);
}

double cTerrainGen2D::BuildGaps(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
...
double cTerrainGen2D::BuildSteps(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
...
double cTerrainGen2D::BuildWalls(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
...
double cTerrainGen2D::BuildBumps(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
...
double cTerrainGen2D::BuildMixed(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
	double total_w = 0;
...
double cTerrainGen2D::BuildNarrowGaps(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
...
double cTerrainGen2D::BuildSlopes(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
...
double cTerrainGen2D::BuildSlopesGaps(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
	const double delta_range = std::abs(params[eParamsSlopeDeltaRange]);
	const double delta_min = params[eParamsSlopeDeltaMin];
	const double delta_max = params[eParamsSlopeDeltaMax];
...
double cTerrainGen2D::BuildSlopesSteps(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
	const double delta_range = std::abs(params[eParamsSlopeDeltaRange]);
	const double delta_min = params[eParamsSlopeDeltaMin];
	const double delta_max = params[eParamsSlopeDeltaMax];
...
double cTerrainGen2D::BuildSlopesWalls(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
	const double delta_range = std::abs(params[eParamsSlopeDeltaRange]);
	const double delta_min = params[eParamsSlopeDeltaMin];
	const double delta_max = params[eParamsSlopeDeltaMax];
...
double cTerrainGen2D::BuildSlopesMixed(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
	const double delta_range = std::abs(params[eParamsSlopeDeltaRange]);
	const double delta_min = params[eParamsSlopeDeltaMin];
	const double delta_max = params[eParamsSlopeDeltaMax];
...
double cTerrainGen2D::BuildSlopesNarrowGaps(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{
	const double delta_range = std::abs(params[eParamsSlopeDeltaRange]);
	const double delta_min = params[eParamsSlopeDeltaMin];
	const double delta_max = params[eParamsSlopeDeltaMax];
...
double cTerrainGen2D::BuildCliffs(double width, const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data)
{

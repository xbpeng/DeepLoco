...
/// @def TERRAINRL_API
/// @brief Defines that the corresponding function/variable/symbol should be made available from the TerrainRL library.
#ifdef _WIN32
#define TERRAINRL_API __declspec(dllexport)
#else
#define TERRAINRL_API
#endif
